...
## Corpus Check
- 99 files · ~18,373 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 470 nodes · 1094 edges · 37 communities (35 shown, 2 thin omitted)
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 357 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `42bd70c5`
...
- `str` --uses--> `DnsCheckResult`  [INFERRED]
  backend/tests/test_api.py → backend/app/api/v1/dns.py
...
Cohesion: 0.06
Nodes (48): create_inbox(), delete_inbox(), get_inboxes(), gmail_oauth_callback(), gmail_oauth_start(), Send a test email using the inbox credentials, List all inbox connections for the logged-in user, Create a new manual inbox connection (SMTP/IMAP mostly) (+40 more)

### Community 2 - "Community 2"
Cohesion: 0.13
Nodes (50): Domain, Request, Session, User, UUID, Domain, Request, Session (+42 more)
...
Cohesion: 0.12
Nodes (32): DnsCheckResult, Request, Session, User, UUID, str, DnsCheckResult, str (+24 more)

### Community 6 - "Community 6"
Cohesion: 0.25
Nodes (18): Domain, Request, Session, User, UUID, bool, int, str (+10 more)
...
Cohesion: 0.08
Nodes (22): int, str, str, str, compute_score(), datetime, Ember Product Logo, Blacklist Monitoring Feature (+14 more)
...
- **Why does `User` connect `Community 2` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 10`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `datetime` connect `Community 10` to `Community 2`, `Community 4`, `Community 5`, `Community 6`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `FastAPI` connect `Community 3` to `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`?**
